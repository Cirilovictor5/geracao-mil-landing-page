    ...
    >
      <div className="max-w-[375px] mx-auto">
        ...
        <div className="space-y-4">
          {/* Card 1 - YouTube */}
          <div className="bg-gradient-to-br from-[#1c398e] to-[#193cb8] rounded-2xl overflow-hidden shadow-xl p-5">
            <div className="flex items-start gap-3 mb-4">
              <div className="bg-[#fdc700] rounded-xl p-3 shrink-0">
            ...
            <a 
              ...
              className="block w-full bg-[#fdc700] hover:bg-[#e5b500] transition-colors rounded-xl py-3 text-center font-['Arimo:Bold',sans-serif] font-bold text-[14px] leading-[20px] text-[#1c398e]"
            >
