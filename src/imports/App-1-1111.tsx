...
export default function App() {
  return (
    <div className="bg-white relative w-full min-h-screen" data-name="App">
      ...
      <div id="faq-desktop" className="hidden md:flex absolute content-stretch flex-col h-[1136px] items-start left-0 pb-0 pt-[96px] px-[380px] top-[17554px] w-[1528px]" data-name="FAQSection">
        <BackgroundImage />
      ...
      <div id="planos-desktop" className="hidden md:flex absolute content-stretch flex-col h-[1746px] items-start left-[8px] pb-0 pt-[96px] px-0 top-[15468px] w-[1528px]" data-name="PlansSection">
        <BackgroundImage />
